...
#
# Outputs
#   - logs/ddp_dali_{timestamp}.out : stdout / stderr of this script
#   - nsight_logs/ddp_dali_{timestamp}/ : Nsight logs (gpu_1, gpu_2)
#   - runs/ddp_dali_{timestamp}/ : checkpoints
########################################################
...
mkdir -p logs
LOG_FILE="logs/ddp_dali_${TIMESTAMP}.out"
